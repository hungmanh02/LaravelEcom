...
@include('pages.layouts.category_brand')
@endsection
@section('content')
<div class="product-details"><!--product-details-->
    <div class="col-sm-5">
        <div class="view-product">
            <img src="{{ asset('storage/images/products/'.$product_detail->product_image) }}" alt="" />
            <h3>ZOOM</h3>
        </div>
    ...
    <div class="col-sm-7">
        <div class="product-information"><!--/product-information-->
            ...
            <p>Mã ID: {{ $product_detail->product_id }}</p>
            ...
            <form action="{{ URL::to('/save-cart') }}" method="POST">
                ...
                <span>
                    ...
                    <input type="hidden" value="{{ $product_detail->product_id }}" name="productid_hidden" />
                    <button type="submit" class="btn btn-fefault cart" style="margin-left: 0">
